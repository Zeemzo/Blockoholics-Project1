                ...
                <DialogContent dividers>
                    <DialogContentText>
                        ...
                        <Typography variant="body1" color="textSecondary" component="p">
                            This requires the user to provide their email, a unique alias and password, along with a recovery answer for registration.
                            </Typography>
                        <Typography variant="body1" color="textSecondary" component="p">
                            The least bit of user effort is required in managing their blockchain credentials.</Typography>
                        <Typography variant="body1" color="textSecondary" component="p">Increased user information enables 2-factor authentication and multiple ways
                        of recovery.</Typography>
